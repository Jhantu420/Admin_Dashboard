...
function UpdateTestingUser() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:3001/testinguser/${id}`)
      .then((response) => {
  ...
  const handleSubmit = (values, { resetForm }) => {
    ...
    axios
      .put(`http://localhost:3001/testinguser/update/${id}`, updatedUser)
      .then((response) => {
...
export default UpdateTestingUser;
